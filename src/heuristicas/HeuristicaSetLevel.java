...
import fr.uga.pddl4j.heuristics.relaxation.GraphHeuristic;
 ...
 */
public final class HeuristicaSetLevel extends HeuristicaRelaxada {
     ...
     */
    public HeuristicaSetLevel(CodedProblem problem) {
        super(problem);
    ...
    public int estimate(final BitState state, final BitExp goal) {
        super.setGoal(goal);
        return this.expandRelaxedPlanningGraph(state);
    }
